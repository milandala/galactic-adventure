...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "galacticadventureadmin/test/integration/FirstJourney",
    "galacticadventureadmin/test/integration/SpacefarersListJourney",
    "galacticadventureadmin/test/integration/SpacefarersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
