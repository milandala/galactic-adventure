...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "galacticadventure/test/integration/FirstJourney",
    "galacticadventure/test/integration/SpacefarersListJourney",
    "galacticadventure/test/integration/SpacefarersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
